Namespace app.dto.base
    Public Class clsMhinshucategoryBaseDto
        Inherits clsBaseDto
            ...
            ''' </summary>
            ''' <returns></returns>
            Public Property HinshuCategoryName As String
                Get
                    Return _HinshuCategoryName
                End Get
                Set(ByVal value As String)
                    SetProperty(_HinshuCategoryName, value, "HinshuCategoryName")
                End Set
            End Property
            Private _HinshuCategoryName As String

            ''' <summary>
            ''' 
            ''' </summary>
            ''' <returns></returns>
            Public Property HinshuCategoryKanaName As String
                Get
                    Return _HinshuCategoryKanaName
                End Get
                Set(ByVal value As String)
                    SetProperty(_HinshuCategoryKanaName, value, "HinshuCategoryKanaName")
                End Set
            End Property
            Private _HinshuCategoryKanaName As String
