Namespace app.dto
    Public Class clsMtaniBaseDto
        Inherits clsBaseDto
            ...
            ''' </summary>
            ''' <returns></returns>
            Public Property TaniName As String
                Get
                    Return _TaniName
                End Get
                Set(ByVal value As String)
                    SetProperty(_TaniName, value, "TaniName")
                End Set
            End Property
            Private _TaniName As String

            ''' <summary>
            ''' 
            ''' </summary>
            ''' <returns></returns>
            Public Property TaniKigou As String
                Get
                    Return _TaniKigou
                End Get
                Set(ByVal value As String)
                    SetProperty(_TaniKigou, value, "TaniKigou")
                End Set
            End Property
            Private _TaniKigou As String

            ''' <summary>
            ''' 
            ''' </summary>
            ''' <returns></returns>
            Public Property EiziTaniKigou As String
                Get
                    Return _EiziTaniKigou
                End Get
                Set(ByVal value As String)
                    SetProperty(_EiziTaniKigou, value, "EiziTaniKigou")
                End Set
            End Property
            Private _EiziTaniKigou As String
