Namespace app.dto
    Public Class clsMriyoukigyounounyuusakiBaseDto
        Inherits clsBaseDto
            ...
            ''' </summary>
            ''' <returns></returns>
            Public Property NounyuusakiCD As String
                Get
                    Return _NounyuusakiCD
                End Get
                Set(ByVal value As String)
                    SetProperty(_NounyuusakiCD, value, "NounyuusakiCD")
                End Set
            End Property
            Private _NounyuusakiCD As String

            ''' <summary>
            ''' 
            ''' </summary>
            ''' <returns></returns>
            Public Property NounyuusakiName As String
                Get
                    Return _NounyuusakiName
                End Get
                Set(ByVal value As String)
                    SetProperty(_NounyuusakiName, value, "NounyuusakiName")
                End Set
            End Property
            Private _NounyuusakiName As String

            ''' <summary>
            ''' 
            ''' </summary>
            ''' <returns></returns>
            Public Property NounyuusakiKana As String
                Get
                    Return _NounyuusakiKana
                End Get
                Set(ByVal value As String)
                    SetProperty(_NounyuusakiKana, value, "NounyuusakiKana")
                End Set
            End Property
            Private _NounyuusakiKana As String
            ...
            ''' </summary>
            ''' <returns></returns>
            Public Property BushoName As String
                Get
                    Return _BushoName
                End Get
                Set(ByVal value As String)
                    SetProperty(_BushoName, value, "BushoName")
                End Set
            End Property
            Private _BushoName As String

            ''' <summary>
            ''' 
            ''' </summary>
            ''' <returns></returns>
            Public Property TantousyaName As String
                Get
                    Return _TantousyaName
                End Get
                Set(ByVal value As String)
                    SetProperty(_TantousyaName, value, "TantousyaName")
                End Set
            End Property
            Private _TantousyaName As String
