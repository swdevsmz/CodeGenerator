Namespace app.dto
    Public Class clsMhinshuBaseDto
        Inherits clsBaseDto
            ...
            ''' </summary>
            ''' <returns></returns>
            Public Property HinshuName As String
                Get
                    Return _HinshuName
                End Get
                Set(ByVal value As String)
                    SetProperty(_HinshuName, value, "HinshuName")
                End Set
            End Property
            Private _HinshuName As String

            ''' <summary>
            ''' 
            ''' </summary>
            ''' <returns></returns>
            Public Property HinshuKanaName As String
                Get
                    Return _HinshuKanaName
                End Get
                Set(ByVal value As String)
                    SetProperty(_HinshuKanaName, value, "HinshuKanaName")
                End Set
            End Property
            Private _HinshuKanaName As String
